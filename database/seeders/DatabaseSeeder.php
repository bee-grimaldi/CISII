...
class DatabaseSeeder extends Seeder
{
    ...
    private $arrayPeliculas = array(
        array(
            ...
            'poster' => 'https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcRFnUIGQQtTzUxD9Y19nl3uum8SZA6TSA8eWnJoPy1UdHVF8fDn', 
            'rented' => false, 
        ...
        array(
            ...
            'poster' => 'https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcQhvDG0XXLsjZ7pmbcUGegeFn7c7FOZn5zXlm5bTePXCurllmXF', 
            'rented' => false, 
        ...
        array(
            ...
            'poster' => 'https://r4.abcimg.es/resizer/resizer.php?imagen=https%3A%2F%2Fstatic2.abc.es%2Fmedia%2Fpeliculas%2F000%2F003%2F398%2Fel-precio-del-poder-1.jpg&nuevoancho=683&medio=abc', 
            'rented' => false, 
        ...
        array(
            ...
            'poster' => 'https://decine21.com/img/upload/obras/el-pianista-1631/src/el-pianista-1631-c.jpg', 
            'rented' => true, 
        ...
        array(
            ...
            'poster' => 'https://i.pinimg.com/originals/c7/ec/62/c7ec6285f6ba7fdbd29e3a9f3b5244f9.jpg', 
            'rented' => true, 
        ...
        array(
            ...
            'year' => '1987', 
            'director' => 'Stanley Kubrick', 
            'poster' => 'http://2.bp.blogspot.com/-nleaJ_nJZc8/Uz8HZISARpI/AAAAAAAAI6M/OXgLTqYssEQ/s1600/la+chaqueta+metalica+cartel.jpg', 
            'rented' => true, 
        ...
        array(
            ...
            'year' => '1976', 
            'director' => 'Martin Scorsese', 
            'poster' => 'https://m.media-amazon.com/images/I/512QFrcnATL._AC_.jpg', 
            'rented' => false, 
        ...
        array(
            ...
            'year' => '1999', 
            'director' => 'David Fincher', 
            'poster' => 'https://i.pinimg.com/474x/b6/d0/46/b6d04670d01bf45b639223b136939fae--club-poster-tyler-durden.jpg', 
            'rented' => true, 
    ...
    private function seedUsers()
    {
        ...
        // Usuarios de prueba
        $user->name = 'Lucy Aristizabal';
        $user->email = 'lucy@udenar.edu.co';
        $user->password = bcrypt('123456789');
        $user1->name = 'Bee Grimaldi';
        $user1->email = 'bgrimal1@udenar.edu.co';
